...
//     return deliveries.add(delivery.toMap());
//   }

//   Future<void> updateDelivery(Delivery delivery) {
//     return deliveries.doc(delivery.id).update(delivery.toMap());
//   }

//   Future<void> deleteDelivery(String id) async{
//     return await deliveries.doc(id).delete();
//   }

//   Stream<List<Delivery>> getDeliveriesStream() {
//     return deliveries.snapshots().map(
//           (querySnapshot) => querySnapshot.docs
//               .map(
//                 (documentSnapshot) => Delivery.fromMap(
